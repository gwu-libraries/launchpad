...
urlpatterns = patterns('ui.views',
    ...
    url(r'^item/(?P<bibid>\d{2,8})/(?P<z3950>[A-Za-z]+)/(?P<school>[A-Za-z]+)/$', 'item', name='item'),
    ...
    url(r'^oclc/\(OCoLC\)oc[mn](?P<oclc>\d{7,10})$', 'oclc'),
    url(r'^oclc/\(OCoLC\)(?P<oclc>\d{7,10})$', 'oclc'),
    url(r'^oclc/oc[mn](?P<oclc>\d{7,10})$', 'oclc'),
    url(r'^oclc/\(Safari\)(?P<oclc>\d{7,10})$', 'oclc'),
