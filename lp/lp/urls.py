...
urlpatterns = patterns('ui.views',
    ...
    url(r'^item/\.?(?P<gtbibid>b\d{2,8}).json$', 'gtitem_json', name='gtitem_json'),
    url(r'^item/m(?P<gmbibid>\d{2,8})$', 'gmitem', name='gmitem'),
    url(r'^item/m(?P<gmbibid>\d{2,8}).json$', 'gmitem_json', name='gmitem_json'),
    url(r'^issn/(?P<issn>\d{4}-?\d{3}[0-9Xx])$', 'issn', name='issn'),
    url(r'^isbn/(?P<isbn>[0-9-xX]+)$', 'isbn', name='isbn'),
    url(r'^oclc/\(OCoLC\)oc[mn](?P<oclc>\d{7,10})$', 'oclc', name='oclc'),
    url(r'^oclc/\(OCoLC\)(?P<oclc>\d{7,10})$', 'oclc', name='oclc'),
    url(r'^oclc/oc[mn](?P<oclc>\d{7,10})$', 'oclc', name='oclc'),
    url(r'^oclc/\(Safari\)(?P<oclc>\d{7,10})$', 'oclc', name='oclc'),
    url(r'^oclc/(?P<oclc>\d{7,10})$', 'oclc', name='oclc'),
